...
<head>
    ...
    <!-- <title>{{ config('app.name', 'myCommerce') }}</title> -->
...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">myCommerce</a>
                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                    ...
                                    <a class="dropdown-item" href="{{ route('purchases.index') }}">Compras</a>
                                    <a class="dropdown-item" href="{{ route('sales.index') }}">Ventas</a>
                                    <a class="dropdown-item" href="{{ route('inventory.index') }}">Inventario</a>
                                    <a class="dropdown-item" href="{{ route('contacts.index') }}">Contactos</a>
                                    <a class="dropdown-item" href="{{ route('statistics.index') }}">Estadisticas</a>
