                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" name="dni" id="dni" class="form-control" value="{{ $user->dni }}" @if(!auth()->user()->is_admin) disabled @endif>
                            </div>
                            <div class="form-group col-md-4">
                                <label for="email">Email:</label>
                                <input type="text" name="email" id="email" class="form-control" value="{{ $user->email }}" @if(!auth()->user()->is_admin) disabled @endif>
                            </div>
                            <div class="form-group col-md-4">
                                <label for="name">Nombre:</label>
                                <input type="text" name="name" id="name" class="form-control" value="{{ $user->name }}" @if(!auth()->user()->is_admin) disabled @endif>
                            </div>
                            <div class="form-group col-md-4">
                                <label for="lastname">Apellidos:</label>
                                <input type="text" name="lastname" id="lastname" class="form-control" value="{{ $user->lastname }}" @if(!auth()->user()->is_admin) disabled @endif>
                            </div>
